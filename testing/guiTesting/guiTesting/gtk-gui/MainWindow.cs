...
public partial class MainWindow
{
	...
	protected virtual void Build ()
	{
		...
		this.UIManager.AddUiFromString ("<ui><menubar name='menubar2'><menu name='fileAction' action='fileAction'><menuitem name='exitAction1' action='exitAction1'/><menuitem name='openAction' action='openAction'/></menu></menubar></ui>");
		...
		this.openAction.Activated += new global::System.EventHandler (this.@new);
	}
}
